...
module.exports = {
  ...
  MAX_RUN_MS: 15000, // hard cap on a running round (thief timer length)

  // Multiplier curve: m(t) = e^(GROWTH_K * t_seconds)  (accelerating, Aviator-style)
  // GROWTH_K chosen so the 23x hard cap is reached right at ~15s.
  GROWTH_K: 0.21,

  // Crash distribution
  HOUSE_EDGE: 0.03, // probability of an instant 1.00x bust + tail trim
  MAX_MULTIPLIER: 23.0, // cap so a round always fits inside MAX_RUN_MS
